...
{
    public class CommunityItemDtoTests : IUseFixture<AutomapperFixture>
    {
        ...
        public void CanMapToItem()
        {
            ...
            item.Id.ShouldEqual(dto.ItemID);
        ...
        public void CanMapToAssembly()
        {
            ...
            assembly.Id.ShouldEqual(dto.ItemID);
